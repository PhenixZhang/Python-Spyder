...
class app_data:
    ...
    def cat_app_list(self,keyword='疫情'):
        ...
        for item in data:
            ...
            if display_list and isinstance(display_list,list):
                for i in display_list:
                    album_group_dict = i.get('album_group')
                    if album_group_dict:
                        ...
                        if url:
                            url_list.append(url)
            elif display_list and isinstance(display_list,dict):
